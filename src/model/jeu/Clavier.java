    ...
    public void keyPressed(KeyEvent e) {
        ...
        if(e.getKeyCode() == KeyEvent.VK_UP){
            ...
            if(Main.scene.joueurs.get(0).getLaser(tourj1).isVaisseauTir() == false){
                ...
                if(tourj1 == Main.scene.joueurs.get(0).getTir().size()-1){Main.scene.joueurs.get(0).setTourTir(0);}
            }
        }
        //Joueur2
        ...
        if(e.getKeyCode() == KeyEvent.VK_Z){
            ...
            if(Main.scene.joueurs.get(1).getLaser(tourj2).isVaisseauTir() == false){
                ...
                if(tourj2 == Main.scene.joueurs.get(1).getTir().size()-1){Main.scene.joueurs.get(1).setTourTir(0);}
            }
        }
    }
